...
def loadImg():
    ...
    puntatoreImpostazioniDestra = pygame.image.load("Immagini/Puntatori/ScorriImpostazioniDestra.png")
    puntatoreImpostazioniDestra = pygame.transform.scale(puntatoreImpostazioniDestra, (gpx, gpy))
    puntatoreImpostazioniSinistra = pygame.image.load("Immagini/Puntatori/ScorriImpostazioniSinistra.png")
    puntatoreImpostazioniSinistra = pygame.transform.scale(puntatoreImpostazioniSinistra, (gpx, gpy))
    puntatoreImpostazioniDestraBloccato = pygame.image.load("Immagini/Puntatori/ScorriImpostazioniDestraBloccato.png")
    puntatoreImpostazioniDestraBloccato = pygame.transform.scale(puntatoreImpostazioniDestraBloccato, (gpx, gpy))
    puntatoreImpostazioniSinistraBloccato = pygame.image.load("Immagini/Puntatori/ScorriImpostazioniSinistraBloccato.png")
    ...
    persw = pygame.image.load('Immagini/Personaggi/Sara/Personaggio4.png')
    persw = pygame.transform.scale(persw, (gpx, gpy))
    perswb = pygame.image.load('Immagini/Personaggi/Sara/Personaggio4b.png')
    perswb = pygame.transform.scale(perswb, (gpx, gpy))
    persa = pygame.image.load('Immagini/Personaggi/Sara/Personaggio3.png')
    persa = pygame.transform.scale(persa, (gpx, gpy))
    persab = pygame.image.load('Immagini/Personaggi/Sara/Personaggio3b.png')
    ...
    persob = pygame.image.load('Immagini/Personaggi/Sara/Personaggio1b.png')
    perssb = pygame.transform.scale(persob, (gpx, gpy))
    persd = pygame.image.load('Immagini/Personaggi/Sara/Personaggio2.png')
    persd = pygame.transform.scale(persd, (gpx, gpy))
    persdb = pygame.image.load('Immagini/Personaggi/Sara/Personaggio2b.png')
    persdb = pygame.transform.scale(persdb, (gpx, gpy))
    perssm = pygame.image.load('Immagini/Personaggi/Sara/Personaggio1mov.png')
    perssm = pygame.transform.scale(perssm, (gpx, gpy))
    perssmb1 = pygame.image.load('Immagini/Personaggi/Sara/Personaggio1movb1.png')
    perssmb1 = pygame.transform.scale(perssmb1, (gpx, gpy))
    perssmb2 = pygame.image.load('Immagini/Personaggi/Sara/Personaggio1movb2.png')
    perssmb2 = pygame.transform.scale(perssmb2, (gpx, gpy))
    persdm = pygame.image.load('Immagini/Personaggi/Sara/Personaggio2mov.png')
    persdm = pygame.transform.scale(persdm, (gpx, gpy))
    persdmb1 = pygame.image.load('Immagini/Personaggi/Sara/Personaggio2movb1.png')
    persdmb1 = pygame.transform.scale(persdmb1, (gpx, gpy))
    persdmb2 = pygame.image.load('Immagini/Personaggi/Sara/Personaggio2movb2.png')
    persdmb2 = pygame.transform.scale(persdmb2, (gpx, gpy))
    persam = pygame.image.load('Immagini/Personaggi/Sara/Personaggio3mov.png')
    persam = pygame.transform.scale(persam, (gpx, gpy))
    persamb1 = pygame.image.load('Immagini/Personaggi/Sara/Personaggio3movb1.png')
    persamb1 = pygame.transform.scale(persamb1, (gpx, gpy))
    persamb2 = pygame.image.load('Immagini/Personaggi/Sara/Personaggio3movb2.png')
    persamb2 = pygame.transform.scale(persamb2, (gpx, gpy))
    perswm = pygame.image.load('Immagini/Personaggi/Sara/Personaggio4mov.png')
    perswm = pygame.transform.scale(perswm, (gpx, gpy))
    perswmb1 = pygame.image.load('Immagini/Personaggi/Sara/Personaggio4movb1.png')
    perswmb1 = pygame.transform.scale(perswmb1, (gpx, gpy))
    perswmb2 = pygame.image.load('Immagini/Personaggi/Sara/Personaggio4movb2.png')
    perswmb2 = pygame.transform.scale(perswmb2, (gpx, gpy))
    perswmbAttacco = pygame.image.load('Immagini/Personaggi/Sara/Personaggio4movbAttacco.png')
    perswmbAttacco = pygame.transform.scale(perswmbAttacco, (gpx, gpy))
    persambAttacco = pygame.image.load('Immagini/Personaggi/Sara/Personaggio3movbAttacco.png')
    persambAttacco = pygame.transform.scale(persambAttacco, (gpx, gpy))
    perssmbAttacco = pygame.image.load('Immagini/Personaggi/Sara/Personaggio1movbAttacco.png')
    perssmbAttacco = pygame.transform.scale(perssmbAttacco, (gpx, gpy))
    persdmbAttacco = pygame.image.load('Immagini/Personaggi/Sara/Personaggio2movbAttacco.png')
    persdmbAttacco = pygame.transform.scale(persdmbAttacco, (gpx, gpy))
    persmbDifesa = pygame.image.load('Immagini/Personaggi/Sara/PersonaggiomovbDifesa.png')
    persmbDifesa = pygame.transform.scale(persmbDifesa, (gpx, gpy))
    persAvvele = pygame.image.load('Immagini/Personaggi/Sara/PersonaggioAvvelenato.png')
    ...
    while contatoreGlobale < 5:
        vetImgSpadeMenu.append(pygame.transform.scale(pygame.image.load("Immagini/EquipSara/Spade/Spada%iMenu.png" % contatoreGlobale), (int(gpx * 2), int(gpy * 2))))
        vetImgArchiMenu.append(pygame.transform.scale(pygame.image.load("Immagini/EquipSara/Archi/Arco%iMenu.png" % contatoreGlobale), (int(gpx * 2), int(gpy * 2))))
        vetImgArmatureMenu.append(pygame.transform.scale(pygame.image.load("Immagini/EquipSara/Armature/Armatura%iMenu.png" % contatoreGlobale), (int(gpx * 2), int(gpy * 2))))
        vetImgScudiMenu.append(pygame.transform.scale(pygame.image.load("Immagini/EquipSara/Scudi/Scudo%iMenu.png" % contatoreGlobale), (int(gpx * 2), int(gpy * 2))))
        vetImgGuantiMenu.append(pygame.transform.scale(pygame.image.load("Immagini/EquipSara/Guanti/Guanti%iMenu.png" % contatoreGlobale), (int(gpx * 2), int(gpy * 2))))
        vetImgCollaneMenu.append(pygame.transform.scale(pygame.image.load("Immagini/EquipSara/Collane/Collana%iMenu.png" % contatoreGlobale), (int(gpx * 2), int(gpy * 2))))
        contatoreGlobale += 1
    ...
    contatoreGlobale = 0
    while contatoreGlobale < 5:
        vetImgSpadePixellate.append(pygame.image.load("Immagini/EquipSara/Spade/Spada%is.png" % contatoreGlobale))
        vetImgArchiPixellate.append(pygame.image.load("Immagini/EquipSara/Archi/Arco%is.png" % contatoreGlobale))
        vetImgArmaturePixellate.append(pygame.image.load("Immagini/EquipSara/Armature/Armatura%is.png" % contatoreGlobale))
        vetImgScudiPixellate.append(pygame.image.load("Immagini/EquipSara/Scudi/Scudo%is.png" % contatoreGlobale))
        vetImgGuantiPixellate.append(pygame.image.load("Immagini/EquipSara/Guanti/Guanti%is.png" % contatoreGlobale))
        vetImgCollanePixellate.append(pygame.image.load("Immagini/EquipSara/Collane/Collana%is.png" % contatoreGlobale))
        contatoreGlobale += 1
...
robogra = pygame.image.load('Immagini/Disegni/RobotGraf.png')
robograf = pygame.image.load('Immagini/Disegni/RobotGraf2.png')
robograff = pygame.image.load('Immagini/Disegni/RobotGraf3.png')
robografff = pygame.image.load('Immagini/Disegni/RobotGraf4.png')
robograffff = pygame.image.load('Immagini/Disegni/RobotGrafsalva.png')
...
imgFraMaggioreMenuOggetti = pygame.image.load('Immagini/DecorazioniMenu/FratelloMaggioreMenu.png')
imgSaraMenuOggetti = pygame.image.load('Immagini/DecorazioniMenu/SaraMenu.png')
# indicatori vita
