...
def loadImgs():
    ...
    persGrafMenu = loadImage('Immagini/Disegni/RalloGrafMenu.png', False)
    persGrafMenu = pygame.transform.smoothscale(persGrafMenu, (gpx * 18, gpy * 18))
    saraGrafMenu = loadImage('Immagini/Disegni/SaraGrafMenu.png', False)
    saraGrafMenu = pygame.transform.smoothscale(saraGrafMenu, (gpx * 10, gpy * 10))
    fraMaggioreGrafMenu = loadImage('Immagini/Disegni/FratelloMaggioreGrafMenu.png', False)
    fraMaggioreGrafMenu = pygame.transform.smoothscale(fraMaggioreGrafMenu, (gpx * 10, gpy * 10))
    robograf0 = loadImage('Immagini/Disegni/RobotGraf0.png', False)
    robograf0 = pygame.transform.smoothscale(robograf0, (gpx * 18, gpy * 18))
    robograf1o = loadImage('Immagini/Disegni/RobotGraf1.png', False)
    ...
    robograf2o = loadImage('Immagini/Disegni/RobotGraf2.png', False)
    ...
    robograf3 = loadImage('Immagini/Disegni/RobotGraf3.png', False)
    robograf3 = pygame.transform.smoothscale(robograf3, (gpx * 18, gpy * 18))
    robograf4 = loadImage('Immagini/Disegni/RobotGraf4.png', False)
...
suonochiusuraporte3 = loadSound("Audio/RumoriAmbiente/ChiusuraPorta3.wav")
