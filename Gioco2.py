    ...
    while True:
        ...
        if carim:
            ...
            if cambiosta:
                ...
                # stanza
                imgSfondoStanza = GlobalVar.loadImage("Immagini/Scenari/Stanza" + str(dati[1]) + "/Stanza.png", True)
                imgSfondoStanza = pygame.transform.smoothscale(imgSfondoStanza, (GlobalVar.gsx, GlobalVar.gsy))
                sfondinoa = GlobalVar.loadImage("Immagini/Scenari/Stanza" + str(dati[1]) + "/SfondinoA.png", True)
                sfondinoa = pygame.transform.smoothscale(sfondinoa, (GlobalVar.gpx, GlobalVar.gpy))
                sfondinob = GlobalVar.loadImage("Immagini/Scenari/Stanza" + str(dati[1]) + "/SfondinoB.png", True)
                sfondinob = pygame.transform.smoothscale(sfondinob, (GlobalVar.gpx, GlobalVar.gpy))
                sfondinoc = GlobalVar.loadImage("Immagini/Scenari/Stanza" + str(dati[1]) + "/SfondinoC.png", True)
                sfondinoc = pygame.transform.smoothscale(sfondinoc, (GlobalVar.gpx, GlobalVar.gpy))
                portaVert = GlobalVar.loadImage("Immagini/Scenari/Stanza" + str(dati[1]) + "/PortaVerticale.png")
                portaVert = pygame.transform.smoothscale(portaVert, (GlobalVar.gpx, GlobalVar.gpy))
                portaOriz = GlobalVar.loadImage("Immagini/Scenari/Stanza" + str(dati[1]) + "/PortaOrizzontale.png")
            ...
            if not cambiosta:
                # arma
                armaw = GlobalVar.loadImage("Immagini/EquipSara/Spade/Spada%iw.png" % dati[6])
                armaw = pygame.transform.smoothscale(armaw, (GlobalVar.gpx, GlobalVar.gpy))
                armawMov1 = GlobalVar.loadImage("Immagini/EquipSara/Spade/Spada%iwMov1.png" % dati[6])
                armawMov1 = pygame.transform.smoothscale(armawMov1, (GlobalVar.gpx, GlobalVar.gpy))
                armawMov2 = GlobalVar.loadImage("Immagini/EquipSara/Spade/Spada%iwMov2.png" % dati[6])
                armawMov2 = pygame.transform.smoothscale(armawMov2, (GlobalVar.gpx, GlobalVar.gpy))
                armaa = GlobalVar.loadImage("Immagini/EquipSara/Spade/Spada%ia.png" % dati[6])
                armaa = pygame.transform.smoothscale(armaa, (GlobalVar.gpx, GlobalVar.gpy))
                armaaMov1 = GlobalVar.loadImage("Immagini/EquipSara/Spade/Spada%iaMov1.png" % dati[6])
                armaaMov1 = pygame.transform.smoothscale(armaaMov1, (GlobalVar.gpx, GlobalVar.gpy))
                armaaMov2 = GlobalVar.loadImage("Immagini/EquipSara/Spade/Spada%iaMov2.png" % dati[6])
                armaaMov2 = pygame.transform.smoothscale(armaaMov2, (GlobalVar.gpx, GlobalVar.gpy))
                armas = GlobalVar.loadImage("Immagini/EquipSara/Spade/Spada%is.png" % dati[6])
                armas = pygame.transform.smoothscale(armas, (GlobalVar.gpx, GlobalVar.gpy))
                armasMov1 = GlobalVar.loadImage("Immagini/EquipSara/Spade/Spada%isMov1.png" % dati[6])
                armasMov1 = pygame.transform.smoothscale(armasMov1, (GlobalVar.gpx, GlobalVar.gpy))
                armasMov2 = GlobalVar.loadImage("Immagini/EquipSara/Spade/Spada%isMov2.png" % dati[6])
                armasMov2 = pygame.transform.smoothscale(armasMov2, (GlobalVar.gpx, GlobalVar.gpy))
                armad = GlobalVar.loadImage("Immagini/EquipSara/Spade/Spada%id.png" % dati[6])
                armad = pygame.transform.smoothscale(armad, (GlobalVar.gpx, GlobalVar.gpy))
                armadMov1 = GlobalVar.loadImage("Immagini/EquipSara/Spade/Spada%idMov1.png" % dati[6])
                armadMov1 = pygame.transform.smoothscale(armadMov1, (GlobalVar.gpx, GlobalVar.gpy))
                armadMov2 = GlobalVar.loadImage("Immagini/EquipSara/Spade/Spada%idMov2.png" % dati[6])
                armadMov2 = pygame.transform.smoothscale(armadMov2, (GlobalVar.gpx, GlobalVar.gpy))
                armasAttacco = GlobalVar.loadImage("Immagini/EquipSara/Spade/Spada%isAttacco.png" % dati[6])
                armasAttacco = pygame.transform.smoothscale(armasAttacco, (GlobalVar.gpx, GlobalVar.gpy * 2))
                armaaAttacco = GlobalVar.loadImage("Immagini/EquipSara/Spade/Spada%iaAttacco.png" % dati[6])
                armaaAttacco = pygame.transform.smoothscale(armaaAttacco, (GlobalVar.gpx * 2, GlobalVar.gpy))
                armadAttacco = GlobalVar.loadImage("Immagini/EquipSara/Spade/Spada%idAttacco.png" % dati[6])
                armadAttacco = pygame.transform.smoothscale(armadAttacco, (GlobalVar.gpx * 2, GlobalVar.gpy))
                armawAttacco = GlobalVar.loadImage("Immagini/EquipSara/Spade/Spada%iwAttacco.png" % dati[6])
                armawAttacco = pygame.transform.smoothscale(armawAttacco, (GlobalVar.gpx, GlobalVar.gpy * 2))
                # arco
                arcow = GlobalVar.loadImage("Immagini/EquipSara/Archi/Arco%iw.png" % dati[128])
                arcow = pygame.transform.smoothscale(arcow, (GlobalVar.gpx, GlobalVar.gpy))
                arcoa = GlobalVar.loadImage("Immagini/EquipSara/Archi/Arco%ia.png" % dati[128])
                arcoa = pygame.transform.smoothscale(arcoa, (GlobalVar.gpx, GlobalVar.gpy))
                arcos = GlobalVar.loadImage("Immagini/EquipSara/Archi/Arco%is.png" % dati[128])
                arcos = pygame.transform.smoothscale(arcos, (GlobalVar.gpx, GlobalVar.gpy))
                arcod = GlobalVar.loadImage("Immagini/EquipSara/Archi/Arco%id.png" % dati[128])
                arcod = pygame.transform.smoothscale(arcod, (GlobalVar.gpx, GlobalVar.gpy))
                arcosAttacco = GlobalVar.loadImage("Immagini/EquipSara/Archi/Arco%isAttacco.png" % dati[128])
                arcosAttacco = pygame.transform.smoothscale(arcosAttacco, (GlobalVar.gpx, GlobalVar.gpy * 2))
                arcoaAttacco = GlobalVar.loadImage("Immagini/EquipSara/Archi/Arco%iaAttacco.png" % dati[128])
                arcoaAttacco = pygame.transform.smoothscale(arcoaAttacco, (GlobalVar.gpx * 2, GlobalVar.gpy))
                arcodAttacco = GlobalVar.loadImage("Immagini/EquipSara/Archi/Arco%idAttacco.png" % dati[128])
                arcodAttacco = pygame.transform.smoothscale(arcodAttacco, (GlobalVar.gpx * 2, GlobalVar.gpy))
                arcowAttacco = GlobalVar.loadImage("Immagini/EquipSara/Archi/Arco%iwAttacco.png" % dati[128])
                arcowAttacco = pygame.transform.smoothscale(arcowAttacco, (GlobalVar.gpx, GlobalVar.gpy * 2))
                # faretra
                faretraw = GlobalVar.loadImage("Immagini/EquipSara/Faretre/Faretra%iw.png" % dati[133])
                faretraw = pygame.transform.smoothscale(faretraw, (GlobalVar.gpx, GlobalVar.gpy))
                faretraa = GlobalVar.loadImage("Immagini/EquipSara/Faretre/Faretra%ia.png" % dati[133])
                faretraa = pygame.transform.smoothscale(faretraa, (GlobalVar.gpx, GlobalVar.gpy))
                faretras = GlobalVar.loadImage("Immagini/EquipSara/Faretre/Faretra%is.png" % dati[133])
                faretras = pygame.transform.smoothscale(faretras, (GlobalVar.gpx, GlobalVar.gpy))
                faretrad = GlobalVar.loadImage("Immagini/EquipSara/Faretre/Faretra%id.png" % dati[133])
                faretrad = pygame.transform.smoothscale(faretrad, (GlobalVar.gpx, GlobalVar.gpy))
                # armatura
                armaturaw = GlobalVar.loadImage("Immagini/EquipSara/Armature/Armatura%iw.png" % dati[8])
                armaturaw = pygame.transform.smoothscale(armaturaw, (GlobalVar.gpx, GlobalVar.gpy))
                armaturaa = GlobalVar.loadImage("Immagini/EquipSara/Armature/Armatura%ia.png" % dati[8])
                armaturaa = pygame.transform.smoothscale(armaturaa, (GlobalVar.gpx, GlobalVar.gpy))
                armaturas = GlobalVar.loadImage("Immagini/EquipSara/Armature/Armatura%is.png" % dati[8])
                armaturas = pygame.transform.smoothscale(armaturas, (GlobalVar.gpx, GlobalVar.gpy))
                armaturad = GlobalVar.loadImage("Immagini/EquipSara/Armature/Armatura%id.png" % dati[8])
                armaturad = pygame.transform.smoothscale(armaturad, (GlobalVar.gpx, GlobalVar.gpy))
                # scudo
                scudow = GlobalVar.loadImage("Immagini/EquipSara/Scudi/Scudo%iw.png" % dati[7])
                scudow = pygame.transform.smoothscale(scudow, (GlobalVar.gpx, GlobalVar.gpy))
                scudoa = GlobalVar.loadImage("Immagini/EquipSara/Scudi/Scudo%ia.png" % dati[7])
                scudoa = pygame.transform.smoothscale(scudoa, (GlobalVar.gpx, GlobalVar.gpy))
                scudos = GlobalVar.loadImage("Immagini/EquipSara/Scudi/Scudo%is.png" % dati[7])
                scudos = pygame.transform.smoothscale(scudos, (GlobalVar.gpx, GlobalVar.gpy))
                scudod = GlobalVar.loadImage("Immagini/EquipSara/Scudi/Scudo%id.png" % dati[7])
                scudod = pygame.transform.smoothscale(scudod, (GlobalVar.gpx, GlobalVar.gpy))
                scudoDifesa = GlobalVar.loadImage("Immagini/EquipSara/Scudi/Scudo%iDifesa.png" % dati[7])
                scudoDifesa = pygame.transform.smoothscale(scudoDifesa, (GlobalVar.gpx, GlobalVar.gpy))
                # guanti
                guantiw = GlobalVar.loadImage("Immagini/EquipSara/Guanti/Guanti%iw.png" % dati[129])
                guantiw = pygame.transform.smoothscale(guantiw, (GlobalVar.gpx, GlobalVar.gpy))
                guantiwMov1 = GlobalVar.loadImage("Immagini/EquipSara/Guanti/Guanti%iwMov1.png" % dati[129])
                guantiwMov1 = pygame.transform.smoothscale(guantiwMov1, (GlobalVar.gpx, GlobalVar.gpy))
                guantiwMov2 = GlobalVar.loadImage("Immagini/EquipSara/Guanti/Guanti%iwMov2.png" % dati[129])
                guantiwMov2 = pygame.transform.smoothscale(guantiwMov2, (GlobalVar.gpx, GlobalVar.gpy))
                guantia = GlobalVar.loadImage("Immagini/EquipSara/Guanti/Guanti%ia.png" % dati[129])
                guantia = pygame.transform.smoothscale(guantia, (GlobalVar.gpx, GlobalVar.gpy))
                guantiaMov1 = GlobalVar.loadImage("Immagini/EquipSara/Guanti/Guanti%iaMov1.png" % dati[129])
                guantiaMov1 = pygame.transform.smoothscale(guantiaMov1, (GlobalVar.gpx, GlobalVar.gpy))
                guantiaMov2 = GlobalVar.loadImage("Immagini/EquipSara/Guanti/Guanti%iaMov2.png" % dati[129])
                guantiaMov2 = pygame.transform.smoothscale(guantiaMov2, (GlobalVar.gpx, GlobalVar.gpy))
                guantis = GlobalVar.loadImage("Immagini/EquipSara/Guanti/Guanti%is.png" % dati[129])
                guantis = pygame.transform.smoothscale(guantis, (GlobalVar.gpx, GlobalVar.gpy))
                guantisMov1 = GlobalVar.loadImage("Immagini/EquipSara/Guanti/Guanti%isMov1.png" % dati[129])
                guantisMov1 = pygame.transform.smoothscale(guantisMov1, (GlobalVar.gpx, GlobalVar.gpy))
                guantisMov2 = GlobalVar.loadImage("Immagini/EquipSara/Guanti/Guanti%isMov2.png" % dati[129])
                guantisMov2 = pygame.transform.smoothscale(guantisMov2, (GlobalVar.gpx, GlobalVar.gpy))
                guantid = GlobalVar.loadImage("Immagini/EquipSara/Guanti/Guanti%id.png" % dati[129])
                guantid = pygame.transform.smoothscale(guantid, (GlobalVar.gpx, GlobalVar.gpy))
                guantidMov1 = GlobalVar.loadImage("Immagini/EquipSara/Guanti/Guanti%idMov1.png" % dati[129])
                guantidMov1 = pygame.transform.smoothscale(guantidMov1, (GlobalVar.gpx, GlobalVar.gpy))
                guantidMov2 = GlobalVar.loadImage("Immagini/EquipSara/Guanti/Guanti%idMov2.png" % dati[129])
                guantidMov2 = pygame.transform.smoothscale(guantidMov2, (GlobalVar.gpx, GlobalVar.gpy))
                guantisAttacco = GlobalVar.loadImage("Immagini/EquipSara/Guanti/Guanti%isAttacco.png" % dati[129])
                guantisAttacco = pygame.transform.smoothscale(guantisAttacco, (GlobalVar.gpx, GlobalVar.gpy))
                guantiaAttacco = GlobalVar.loadImage("Immagini/EquipSara/Guanti/Guanti%iaAttacco.png" % dati[129])
                guantiaAttacco = pygame.transform.smoothscale(guantiaAttacco, (GlobalVar.gpx, GlobalVar.gpy))
                guantidAttacco = GlobalVar.loadImage("Immagini/EquipSara/Guanti/Guanti%idAttacco.png" % dati[129])
                guantidAttacco = pygame.transform.smoothscale(guantidAttacco, (GlobalVar.gpx, GlobalVar.gpy))
                guantiwAttacco = GlobalVar.loadImage("Immagini/EquipSara/Guanti/Guanti%iwAttacco.png" % dati[129])
                guantiwAttacco = pygame.transform.smoothscale(guantiwAttacco, (GlobalVar.gpx, GlobalVar.gpy))
                guantiDifesa = GlobalVar.loadImage("Immagini/EquipSara/Guanti/Guanti%iDifesa.png" % dati[129])
                guantiDifesa = pygame.transform.smoothscale(guantiDifesa, (GlobalVar.gpx, GlobalVar.gpy))
                # collana
                collanaw = GlobalVar.loadImage("Immagini/EquipSara/Collane/Collana%iw.png" % dati[130])
                collanaw = pygame.transform.smoothscale(collanaw, (GlobalVar.gpx, GlobalVar.gpy))
                collanaa = GlobalVar.loadImage("Immagini/EquipSara/Collane/Collana%ia.png" % dati[130])
                collanaa = pygame.transform.smoothscale(collanaa, (GlobalVar.gpx, GlobalVar.gpy))
                collanas = GlobalVar.loadImage("Immagini/EquipSara/Collane/Collana%is.png" % dati[130])
                collanas = pygame.transform.smoothscale(collanas, (GlobalVar.gpx, GlobalVar.gpy))
                collanad = GlobalVar.loadImage("Immagini/EquipSara/Collane/Collana%id.png" % dati[130])
                collanad = pygame.transform.smoothscale(collanad, (GlobalVar.gpx, GlobalVar.gpy))
                # armatura robot
                armrobw = GlobalVar.loadImage("Immagini/EquipRobo/Batteria%iw.png" % dati[9])
                armrobw = pygame.transform.smoothscale(armrobw, (GlobalVar.gpx, GlobalVar.gpy))
                armroba = GlobalVar.loadImage("Immagini/EquipRobo/Batteria%ia.png" % dati[9])
                armroba = pygame.transform.smoothscale(armroba, (GlobalVar.gpx, GlobalVar.gpy))
                armrobs = GlobalVar.loadImage("Immagini/EquipRobo/Batteria%is.png" % dati[9])
                armrobs = pygame.transform.smoothscale(armrobs, (GlobalVar.gpx, GlobalVar.gpy))
                armrobd = GlobalVar.loadImage("Immagini/EquipRobo/Batteria%id.png" % dati[9])
