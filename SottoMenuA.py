    ...
    while not risposta:
        ...
        if aggiornaSchermo or primoMovimento or (tastoMovimentoPremuto and tastotempfps == 0) or primoFrame or voceMarcataVecchia != voceMarcata or aggiornaInterfacciaPerCambioInput:
            ...
            if primoFrame:
                ...
                pygame.draw.line(GlobalVar.schermo, GlobalVar.grigiochi, (int(GlobalVar.gpx * 1.5), int(GlobalVar.gpy * 5.6)), (int(GlobalVar.gpx * 21.5), int(GlobalVar.gpy * 5.6)), 1)
                i = 0
                while i < 5:
            ...
            pygame.draw.line(GlobalVar.schermo, GlobalVar.grigioscu, ((GlobalVar.gsx // 32 * 4.5) - 1, (GlobalVar.gsy // 18 * 6.1) + (GlobalVar.gpy // 2)), ((GlobalVar.gsx // 32 * 4.5) - 1, (GlobalVar.gsy // 18 * 15) + (GlobalVar.gpy // 2)), 1)
            pygame.draw.line(GlobalVar.schermo, GlobalVar.grigioscu, ((GlobalVar.gsx // 32 * 8) - 1, (GlobalVar.gsy // 18 * 3.8) + (GlobalVar.gpy // 2)), ((GlobalVar.gsx // 32 * 8) - 1, (GlobalVar.gsy // 18 * 4.9) + (GlobalVar.gpy // 2)), 2)
            pygame.draw.line(GlobalVar.schermo, GlobalVar.grigioscu, ((GlobalVar.gsx // 32 * 8) - 1, (GlobalVar.gsy // 18 * 5.3) + (GlobalVar.gpy // 2)), ((GlobalVar.gsx // 32 * 8) - 1, (GlobalVar.gsy // 18 * 15.5) + (GlobalVar.gpy // 2)), 2)
            pygame.draw.line(GlobalVar.schermo, GlobalVar.grigioscu, ((GlobalVar.gsx // 32 * 11.5) - 1, (GlobalVar.gsy // 18 * 6.1) + (GlobalVar.gpy // 2)), ((GlobalVar.gsx // 32 * 11.5) - 1, (GlobalVar.gsy // 18 * 15) + (GlobalVar.gpy // 2)), 1)
            pygame.draw.line(GlobalVar.schermo, GlobalVar.grigioscu, ((GlobalVar.gsx // 32 * 15) - 1, (GlobalVar.gsy // 18 * 3.8) + (GlobalVar.gpy // 2)), ((GlobalVar.gsx // 32 * 15) - 1, (GlobalVar.gsy // 18 * 4.9) + (GlobalVar.gpy // 2)), 2)
            pygame.draw.line(GlobalVar.schermo, GlobalVar.grigioscu, ((GlobalVar.gsx // 32 * 15) - 1, (GlobalVar.gsy // 18 * 5.3) + (GlobalVar.gpy // 2)), ((GlobalVar.gsx // 32 * 15) - 1, (GlobalVar.gsy // 18 * 15.5) + (GlobalVar.gpy // 2)), 2)
            pygame.draw.line(GlobalVar.schermo, GlobalVar.grigioscu, ((GlobalVar.gsx // 32 * 18.5) - 1, (GlobalVar.gsy // 18 * 6.1) + (GlobalVar.gpy // 2)), ((GlobalVar.gsx // 32 * 18.5) - 1, (GlobalVar.gsy // 18 * 15) + (GlobalVar.gpy // 2)), 1)
            ...
            pygame.draw.line(GlobalVar.schermo, GlobalVar.grigio, (int(GlobalVar.gpx * 24.5), int(GlobalVar.gpy * 16.3)), (int(GlobalVar.gpx * 29.5), int(GlobalVar.gpy * 16.3)), 2)
    ...
    while not risposta:
        ...
        if aggiornaSchermo or primoMovimento or (tastoMovimentoPremuto and tastotempfps == 0) or primoFrame or voceMarcataVecchia != voceMarcata or aggiornaInterfacciaPerCambioInput:
            ...
            if primoFrame:
                ...
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 8, GlobalVar.gsy // 18 * 4.5, GlobalVar.gsx // 32 * 0.5, GlobalVar.gsy // 18 * 11.5))
            ...
            pygame.draw.line(GlobalVar.schermo, GlobalVar.grigioscu, (int(GlobalVar.gpx * 8) - 1, int(GlobalVar.gpy * 5.7)), (int(GlobalVar.gpx * 8) - 1, int(GlobalVar.gpy * 16)), 2)

            larghezzaTestoDescrizioni = GlobalVar.gpx * 13
            spazioTraLeRigheTestoDescrizione = GlobalVar.gpy // 2
            if voceMarcata == 0:
                GlobalVar.schermo.blit(scecond[0], (GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 4))
            ...
            if voceMarcata == 1:
                if dati[81] > 0:
                    ...
                    GlobalVar.schermo.blit(condSconosciuta, (GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 4))
...
def sceglitecn(dati, tecnica):
    ...
    while not risposta:
        ...
        if aggiornaSchermo or primoMovimento or (tastoMovimentoPremuto and tastotempfps == 0) or primoFrame or voceMarcataVecchia != voceMarcata or aggiornaInterfacciaPerCambioInput:
            ...
            spazioTraLeRigheTestoDescrizione = GlobalVar.gpy // 2
            if voceMarcata == 0:
                GlobalVar.schermo.blit(scetecn[0], (GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 4))
                messaggio("Cancella settaggio:", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 13.5, 60)
                messaggio("Cancella il settaggio di Impo", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 14.5, 35, larghezzaTestoDescrizioni, spazioTraLeRigheTestoDescrizione)
            if voceMarcata == 1:
                if dati[11] > 0:
...
def equiprobo(dati):
    ...
    risposta = False
    riordinamento = False
    turnoPrimaInRiordinamento = False
        ...
        if aggiornaSchermo or primoMovimento or (tastoMovimentoPremuto and tastotempfps == 0) or primoFrame or voceMarcataVecchia != voceMarcata or aggiornaInterfacciaPerCambioInput:
            ...
            if primoFrame:
                ...
                while i < 5:
                    ...
                    i += 1
                pygame.draw.line(GlobalVar.schermo, GlobalVar.grigiochi, (int(GlobalVar.gpx * 1.5), int(GlobalVar.gpy * 5.6)), (int(GlobalVar.gpx * 5.5), int(GlobalVar.gpy * 5.6)), 1)
                pygame.draw.line(GlobalVar.schermo, GlobalVar.grigioscu, (int(GlobalVar.gpx * 10.8) - 1, int(GlobalVar.gpy * 4.4)), (int(GlobalVar.gpx * 10.8) - 1, int(GlobalVar.gpy * 5.4)), 2)
                pygame.draw.line(GlobalVar.schermo, GlobalVar.grigioscu, (int(GlobalVar.gpx * 17) - 1, int(GlobalVar.gpy * 4.4)), (int(GlobalVar.gpx * 17) - 1, int(GlobalVar.gpy * 5.4)), 2)
                pygame.draw.line(GlobalVar.schermo, GlobalVar.grigiochi, (int(GlobalVar.gpx * 7.5), int(GlobalVar.gpy * 5.6)), (int(GlobalVar.gpx * 22.5), int(GlobalVar.gpy * 5.6)), 1)
            else:
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 1, GlobalVar.gsy // 18 * 6.8, GlobalVar.gsx // 32 * 0.5, GlobalVar.gsy // 18 * 9))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 7, GlobalVar.gsy // 18 * 5.8, GlobalVar.gsx // 32 * 0.5, GlobalVar.gsy // 18 * 10.2))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 10.8, GlobalVar.gsy // 18 * 5.8, GlobalVar.gsx // 32 * 0.5, GlobalVar.gsy // 18 * 10.2))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 17, GlobalVar.gsy // 18 * 5.8, GlobalVar.gsx // 32 * 0.5, GlobalVar.gsy // 18 * 10.2))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 7, GlobalVar.gsy // 18 * 6.8, GlobalVar.gsx // 32 * 15.8, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 7, GlobalVar.gsy // 18 * 7.8, GlobalVar.gsx // 32 * 15.8, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 7, GlobalVar.gsy // 18 * 8.8, GlobalVar.gsx // 32 * 15.8, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 7, GlobalVar.gsy // 18 * 9.8, GlobalVar.gsx // 32 * 15.8, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 7, GlobalVar.gsy // 18 * 10.8, GlobalVar.gsx // 32 * 15.8, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 7, GlobalVar.gsy // 18 * 11.8, GlobalVar.gsx // 32 * 15.8, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 7, GlobalVar.gsy // 18 * 12.8, GlobalVar.gsx // 32 * 15.8, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 7, GlobalVar.gsy // 18 * 13.8, GlobalVar.gsx // 32 * 15.8, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 7, GlobalVar.gsy // 18 * 14.8, GlobalVar.gsx // 32 * 15.8, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 7, GlobalVar.gsy // 18 * 15.8, GlobalVar.gsx // 32 * 15.8, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.line(GlobalVar.schermo, GlobalVar.grigioscu, (int(GlobalVar.gpx * 10.8) - 1, int(GlobalVar.gpy * 5.8)), (int(GlobalVar.gpx * 10.8) - 1, int(GlobalVar.gpy * 16)), 2)
                pygame.draw.line(GlobalVar.schermo, GlobalVar.grigioscu, (int(GlobalVar.gpx * 17) - 1, int(GlobalVar.gpy * 5.8)), (int(GlobalVar.gpx * 17) - 1, int(GlobalVar.gpy * 16)), 2)
                if not riordinamento:
            ...
            if riordinamento or primoFrame or turnoPrimaInRiordinamento:
                turnoPrimaInRiordinamento = True
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 7, GlobalVar.gsy // 18 * 5.8, GlobalVar.gsx // 32 * 16, GlobalVar.gsy // 18 * 10.3))
                if riordinamento:
            ...
            if not riordinamento:
                ...
                pygame.draw.line(GlobalVar.schermo, GlobalVar.grigio, (int(GlobalVar.gpx * 25), int(GlobalVar.gpy * 15)), (int(GlobalVar.gpx * 30), int(GlobalVar.gpy * 15)), 2)
            ...
            if voceMarcata >= 6 and not riordinamento:
                pygame.draw.line(GlobalVar.schermo, GlobalVar.grigioscu, (GlobalVar.gsx // 32 * 7.5, yp + (int(GlobalVar.gpy * 0.7))), (GlobalVar.gsx // 32 * 10.6, yp + (int(GlobalVar.gpy * 0.7))), 2)
                pygame.draw.line(GlobalVar.schermo, GlobalVar.grigioscu, (GlobalVar.gsx // 32 * 11, yp + (int(GlobalVar.gpy * 0.7))), (GlobalVar.gsx // 32 * 16.8, yp + (int(GlobalVar.gpy * 0.7))), 2)
                pygame.draw.line(GlobalVar.schermo, GlobalVar.grigioscu, (GlobalVar.gsx // 32 * 17.2, yp + (int(GlobalVar.gpy * 0.7))), (GlobalVar.gsx // 32 * 22.5, yp + (int(GlobalVar.gpy * 0.7))), 2)
            primoFrame = False
    ...
    while not risposta:
        ...
        if aggiornaSchermo or primoMovimento or (tastoMovimentoPremuto and tastotempfps == 0) or primoFrame or voceMarcataVecchia != voceMarcata or oggettonVecchio != oggetton or aggiornaInterfacciaPerCambioInput:
            ...
            if primoFrame:
                ...
                pygame.draw.line(GlobalVar.schermo, GlobalVar.grigioscu, (int(GlobalVar.gpx * 7.6) - 1, int(GlobalVar.gpy * 4.5)), (int(GlobalVar.gpx * 7.6) - 1, int(GlobalVar.gpy * 5.4)), 2)
                pygame.draw.line(GlobalVar.schermo, GlobalVar.grigioscu, (int(GlobalVar.gpx * 7.6) - 1, int(GlobalVar.gpy * 5.8)), (int(GlobalVar.gpx * 7.6) - 1, int(GlobalVar.gpy * 16)), 2)
            else:
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 1, GlobalVar.gsy // 18 * 6, GlobalVar.gsx // 32 * 0.5, GlobalVar.gsy // 18 * 10))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 1, GlobalVar.gsy // 18 * 6.77, GlobalVar.gsx // 32 * 6.5, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 7.7, GlobalVar.gsy // 18 * 6.77, GlobalVar.gsx // 32 * 3, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 1, GlobalVar.gsy // 18 * 7.77, GlobalVar.gsx // 32 * 6.5, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 7.7, GlobalVar.gsy // 18 * 7.77, GlobalVar.gsx // 32 * 3, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 1, GlobalVar.gsy // 18 * 8.77, GlobalVar.gsx // 32 * 6.5, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 7.7, GlobalVar.gsy // 18 * 8.77, GlobalVar.gsx // 32 * 3, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 1, GlobalVar.gsy // 18 * 9.77, GlobalVar.gsx // 32 * 6.5, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 7.7, GlobalVar.gsy // 18 * 9.77, GlobalVar.gsx // 32 * 3, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 1, GlobalVar.gsy // 18 * 10.77, GlobalVar.gsx // 32 * 6.5, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 7.7, GlobalVar.gsy // 18 * 10.77, GlobalVar.gsx // 32 * 3, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 1, GlobalVar.gsy // 18 * 11.77, GlobalVar.gsx // 32 * 6.5, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 7.7, GlobalVar.gsy // 18 * 11.77, GlobalVar.gsx // 32 * 3, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 1, GlobalVar.gsy // 18 * 12.77, GlobalVar.gsx // 32 * 6.5, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 7.7, GlobalVar.gsy // 18 * 12.77, GlobalVar.gsx // 32 * 3, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 1, GlobalVar.gsy // 18 * 13.77, GlobalVar.gsx // 32 * 6.5, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 7.7, GlobalVar.gsy // 18 * 13.77, GlobalVar.gsx // 32 * 3, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 1, GlobalVar.gsy // 18 * 14.77, GlobalVar.gsx // 32 * 6.5, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 7.7, GlobalVar.gsy // 18 * 14.77, GlobalVar.gsx // 32 * 3, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 1, GlobalVar.gsy // 18 * 15.77, GlobalVar.gsx // 32 * 6.5, GlobalVar.gsy // 18 * 0.3))
                pygame.draw.rect(GlobalVar.schermo, GlobalVar.grigio, (GlobalVar.gsx // 32 * 7.7, GlobalVar.gsy // 18 * 15.77, GlobalVar.gsx // 32 * 3, GlobalVar.gsy // 18 * 0.3))
            ...
            GlobalVar.schermo.blit(puntatore, (xp, yp))
            if usa == 0:
                pygame.draw.line(GlobalVar.schermo, GlobalVar.grigioscu, ((xp + (int(GlobalVar.gpx * 0.5))), yp + (int(GlobalVar.gpy * 0.7)) - 1), (xp + (int(GlobalVar.gpx * 6.4)), yp + (int(GlobalVar.gpy * 0.7)) - 1), 2)
                pygame.draw.line(GlobalVar.schermo, GlobalVar.grigioscu, ((xp + (int(GlobalVar.gpx * 6.8))), yp + (int(GlobalVar.gpy * 0.7)) - 1), (xp + (int(GlobalVar.gpx * 9.5)), yp + (int(GlobalVar.gpy * 0.7)) - 1), 2)
            else:
                pygame.draw.line(GlobalVar.schermo, GlobalVar.grigioscu, ((xpv + (int(GlobalVar.gpx * 0.5))), ypv + (int(GlobalVar.gpy * 0.7)) - 1), (xpv + (int(GlobalVar.gpx * 6.4)), ypv + (int(GlobalVar.gpy * 0.7)) - 1), 2)
                pygame.draw.line(GlobalVar.schermo, GlobalVar.grigioscu, ((xpv + (int(GlobalVar.gpx * 6.8))), ypv + (int(GlobalVar.gpy * 0.7)) - 1), (xpv + (int(GlobalVar.gpx * 9.5)), ypv + (int(GlobalVar.gpy * 0.7)) - 1), 2)
            primoFrame = False
