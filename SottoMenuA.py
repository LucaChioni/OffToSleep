        ...
        if aggiornaSchermo or primoMovimento or (tastoMovimentoPremuto and tastotempfps == 0) or primoFrame or voceMarcataVecchia != voceMarcata or aggiornaInterfacciaPerCambioInput:
            ...
            if voceMarcata == 4:
                if dati[44] != 0:
                    ...
                    messaggio("Spada molto leggera e affilata. Si dice essere stata ricavata da un dente di un enorme lupo.", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 23, GlobalVar.gsy // 18 * 4.8, 35, larghezzaTestoDescrizioni, spazioTraLeRigheTestoDescrizione)
            ...
            if voceMarcata == 14:
                if dati[54] != 0:
                    ...
                    messaggio("Armatura formata da materiali leggieri e resistenti. Si dice essere stata ricavata dalle ossa di un enorme lupo.", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 23, GlobalVar.gsy // 18 * 4.8, 35, larghezzaTestoDescrizioni, spazioTraLeRigheTestoDescrizione)
            ...
            if voceMarcata == 19:
                if dati[59] != 0:
                    ...
                    messaggio(u"Scudo molto leggero e resistente. Si dice essere stato ricavato dalle ossa più resistenti di un enorme lupo.", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 23, GlobalVar.gsy // 18 * 4.8, 35, larghezzaTestoDescrizioni, spazioTraLeRigheTestoDescrizione)
            ...
            if voceMarcata == 22:
                if dati[62] != 0:
                    ...
                    messaggio("Guanti che aumentano i <*>#italic#Pv<*> massimi del portatore.", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 23, GlobalVar.gsy // 18 * 4.8, 35, larghezzaTestoDescrizioni, spazioTraLeRigheTestoDescrizione)
                    if dati[129] != 1:
            ...
            if voceMarcata == 27:
                if dati[67] != 0:
                    ...
                    messaggio("Collana composta da erbe il cui odore ripristina <*>#italic#Pv<*> ogni turno.", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 23, GlobalVar.gsy // 18 * 4.8, 35, larghezzaTestoDescrizioni, spazioTraLeRigheTestoDescrizione)
                else:
                    messaggio("Sconosciuto", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 23, GlobalVar.gsy // 18 * 3.8, 60)
            if voceMarcata == 28:
                if dati[68] != 0:
                    messaggio("Collana medicinale:", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 23, GlobalVar.gsy // 18 * 3.8, 60)
                    messaggio(u"Collana composta da erbe il cui odore neutralizza la tossicità del veleno (non ha effetto se si è già avvelenati).", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 23, GlobalVar.gsy // 18 * 4.8, 35, larghezzaTestoDescrizioni, spazioTraLeRigheTestoDescrizione)
                else:
                    messaggio("Sconosciuto", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 23, GlobalVar.gsy // 18 * 3.8, 60)
            if voceMarcata == 29:
                if dati[69] != 0:
        ...
        if aggiornaSchermo or primoMovimento or (tastoMovimentoPremuto and tastotempfps == 0) or primoFrame or voceMarcataVecchia != voceMarcata or aggiornaInterfacciaPerCambioInput:
            ...
            if voceMarcata == 1:
                if dati[81] > 0:
                    ...
                    messaggio("Esegue l'azione su Lucy se la vede e ha <*>#italic#Pv<*> < 80%.", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 14.5, 35, larghezzaTestoDescrizioni, spazioTraLeRigheTestoDescrizione)
                else:
            ...
            if voceMarcata == 2:
                if dati[82] > 0:
                    ...
                    messaggio("Esegue l'azione su Lucy se la vede e ha <*>#italic#Pv<*> < 50%.", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 14.5, 35, larghezzaTestoDescrizioni, spazioTraLeRigheTestoDescrizione)
                else:
                    GlobalVar.disegnaImmagineSuSchermo(condSconosciuta, (GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 4))
                    messaggio("Sconosciuta", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 13.5, 60)
            if voceMarcata == 3:
                if dati[83] > 0:
                    ...
                    messaggio("Esegue l'azione su Lucy se la vede e ha <*>#italic#Pv<*> < 30%.", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 14.5, 35, larghezzaTestoDescrizioni, spazioTraLeRigheTestoDescrizione)
                else:
                    GlobalVar.disegnaImmagineSuSchermo(condSconosciuta, (GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 4))
                    messaggio("Sconosciuta", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 13.5, 60)
            if voceMarcata == 4:
            ...
            if voceMarcata == 6:
                if dati[86] > 0:
                    ...
                    messaggio("Esegue l'azione su Impo quando ha <*>#italic#Pe<*> < 80%.", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 14.5, 35, larghezzaTestoDescrizioni, spazioTraLeRigheTestoDescrizione)
                else:
                    GlobalVar.disegnaImmagineSuSchermo(condSconosciuta, (GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 4))
                    messaggio("Sconosciuta", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 13.5, 60)
            if voceMarcata == 7:
                if dati[87] > 0:
                    ...
                    messaggio("Esegue l'azione su Impo quando ha <*>#italic#Pe<*> < 50%.", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 14.5, 35, larghezzaTestoDescrizioni, spazioTraLeRigheTestoDescrizione)
                else:
                    GlobalVar.disegnaImmagineSuSchermo(condSconosciuta, (GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 4))
                    messaggio("Sconosciuta", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 13.5, 60)
            if voceMarcata == 8:
                if dati[88] > 0:
                    ...
                    messaggio("Esegue l'azione su Impo quando ha <*>#italic#Pe<*> < 30%.", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 14.5, 35, larghezzaTestoDescrizioni, spazioTraLeRigheTestoDescrizione)
                else:
                    GlobalVar.disegnaImmagineSuSchermo(condSconosciuta, (GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 4))
                    messaggio("Sconosciuta", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 13.5, 60)
            if voceMarcata == 9:
            ...
            if voceMarcata == 14:
                if dati[94] > 0:
                    ...
                    messaggio(u"Esegue l'azione su un nemico con <*>#italic#Pv<*> < 80% (in caso di molteplici bersagli, esegue l'azione su quello più vicino).", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 14.5, 35, larghezzaTestoDescrizioni, spazioTraLeRigheTestoDescrizione)
                else:
                    GlobalVar.disegnaImmagineSuSchermo(condSconosciuta, (GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 4))
                    messaggio("Sconosciuta", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 13.5, 60)
            if voceMarcata == 15:
                if dati[95] > 0:
                    ...
                    messaggio(u"Esegue l'azione su un nemico con <*>#italic#Pv<*> < 50% (in caso di molteplici bersagli, esegue l'azione su quello più vicino).", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 14.5, 35, larghezzaTestoDescrizioni, spazioTraLeRigheTestoDescrizione)
                else:
                    GlobalVar.disegnaImmagineSuSchermo(condSconosciuta, (GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 4))
                    messaggio("Sconosciuta", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 13.5, 60)
            if voceMarcata == 16:
                if dati[96] > 0:
                    ...
                    messaggio(u"Esegue l'azione su un nemico con <*>#italic#Pv<*> < 30% (in caso di molteplici bersagli, esegue l'azione su quello più vicino).", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 14.5, 35, larghezzaTestoDescrizioni, spazioTraLeRigheTestoDescrizione)
                else:
                    GlobalVar.disegnaImmagineSuSchermo(condSconosciuta, (GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 4))
                    messaggio("Sconosciuta", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 13.5, 60)
            if voceMarcata == 17:
                if dati[97] > 0:
                    ...
                    messaggio(u"Esegue l'azione sul nemico con meno <*>#italic#Pv<*> (in caso di molteplici bersagli, esegue l'azione su quello più vicino).", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 14.5, 35, larghezzaTestoDescrizioni, spazioTraLeRigheTestoDescrizione)
                else:
                    GlobalVar.disegnaImmagineSuSchermo(condSconosciuta, (GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 4))
                    messaggio("Sconosciuta", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 13.5, 60)
            if voceMarcata == 18:
        ...
        if aggiornaSchermo or primoMovimento or (tastoMovimentoPremuto and tastotempfps == 0) or primoFrame or voceMarcataVecchia != voceMarcata or aggiornaInterfacciaPerCambioInput:
            ...
            if voceMarcata == 2:
                if dati[12] > 0:
                    ...
                    messaggio("Recupera un po' di <*>#italic#Pv<*> di Lucy.", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 14.5, 35, larghezzaTestoDescrizioni, spazioTraLeRigheTestoDescrizione)
                else:
                    GlobalVar.disegnaImmagineSuSchermo(condSconosciuta, (GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 4))
                    messaggio("Sconosciuta", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 13.5, 60)
            if voceMarcata == 3:
            ...
            if voceMarcata == 8:
                if dati[18] > 0:
                    ...
                    messaggio("Recupera molti <*>#italic#Pv<*> di Lucy.", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 14.5, 35, larghezzaTestoDescrizioni, spazioTraLeRigheTestoDescrizione)
                else:
                    GlobalVar.disegnaImmagineSuSchermo(condSconosciuta, (GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 4))
                    messaggio("Sconosciuta", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 13.5, 60)
            if voceMarcata == 9:
            ...
            if voceMarcata == 14:
                if dati[24] > 0:
                    ...
                    messaggio(u"Tutte le tecniche costano la metà dei <*>#italic#Pe<*> per 15 turni. Si annulla con surriscaldamento (applicata sempre su Impo).", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 14.5, 35, larghezzaTestoDescrizioni, spazioTraLeRigheTestoDescrizione)
                else:
                    GlobalVar.disegnaImmagineSuSchermo(condSconosciuta, (GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 4))
                    messaggio("Sconosciuta", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 13.5, 60)
            if voceMarcata == 15:
            ...
            if voceMarcata == 16:
                if dati[26] > 0:
                    ...
                    messaggio(u"Recupera un enorme quantità dei <*>#italic#Pv<*> di Lucy.", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 14.5, 35, larghezzaTestoDescrizioni, spazioTraLeRigheTestoDescrizione)
                else:
                    GlobalVar.disegnaImmagineSuSchermo(condSconosciuta, (GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 4))
                    messaggio("Sconosciuta", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 18, GlobalVar.gsy // 18 * 13.5, 60)
            if voceMarcata == 17:
    ...
    while not risposta:
        ...
        if aggiornaSchermo or primoMovimento or (tastoMovimentoPremuto and tastotempfps == 0) or primoFrame or voceMarcataVecchia != voceMarcata or oggettonVecchio != oggetton or aggiornaInterfacciaPerCambioInput:
            ...
            if usa != 0:
                ...
                messaggio(u"Sì", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 13.4, GlobalVar.gsy // 18 * 14.9, 70)
            ...
            if dati[31] >= 0 and oggetton == 1:
                ...
                messaggio("Recupera 100 <*>#italic#Pv<*>.", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 20, GlobalVar.gsy // 18 * 14.5, 35, larghezzaTestoDescrizioni, spazioTraLeRigheTestoDescrizione)
            elif oggetton == 1:
            ...
            if dati[32] >= 0 and oggetton == 2:
                ...
                messaggio("Recupera 250 <*>#italic#Pe<*> di Impo.", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 20, GlobalVar.gsy // 18 * 14.5, 35, larghezzaTestoDescrizioni, spazioTraLeRigheTestoDescrizione)
            elif oggetton == 2:
                messaggio("Sconosciuto", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 20, GlobalVar.gsy // 18 * 13.5, 60)
            ...
            if dati[34] >= 0 and oggetton == 4:
                ...
                messaggio("Recupera 300 <*>#italic#Pv<*>.", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 20, GlobalVar.gsy // 18 * 14.5, 35, larghezzaTestoDescrizioni, spazioTraLeRigheTestoDescrizione)
            elif oggetton == 4:
                messaggio("Sconosciuto", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 20, GlobalVar.gsy // 18 * 13.5, 60)
            if dati[35] >= 0 and oggetton == 5:
                ...
                messaggio("Recupera 600 <*>#italic#Pe<*> di Impo.", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 20, GlobalVar.gsy // 18 * 14.5, 35, larghezzaTestoDescrizioni, spazioTraLeRigheTestoDescrizione)
            elif oggetton == 5:
                messaggio("Sconosciuto", GlobalVar.grigiochi, GlobalVar.gsx // 32 * 20, GlobalVar.gsy // 18 * 13.5, 60)
