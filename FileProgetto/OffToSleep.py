        ...
        if carim:
            ...
            if cambiosta or cambiatoRisoluzione:
                ...
                if cambiosta:
                    ...
                    # metto le bacchePv
                    listaBacchePv = SetNemiciPersonaggiEventi.mettiBacchePv(dati[1])
