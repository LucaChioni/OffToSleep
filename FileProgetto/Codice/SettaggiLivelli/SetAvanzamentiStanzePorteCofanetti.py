...
def definisciAvanzamentiStoria():
    ...
    dictAvanzamentoStoria["indossatoScarpeVeloci"] = i
    i += 1
    ...
    i += 1
    dictAvanzamentoStoria["iniezioneSiringaOperazioneBloccoTempo"] = i
    i += 1
    dictAvanzamentoStoria["apertoOcchiPostIniezioneNeil"] = i
    i += 1
    dictAvanzamentoStoria["dialogoNeilRene1"] = i
    i += 1
    dictAvanzamentoStoria["apertoOcchiPostdialogoNeilRene1"] = i
    i += 1
    ...
    i += 1
    dictAvanzamentoStoria["riletturaLibroNeilSulTempo"] = i
    i += 1
    dictAvanzamentoStoria["monologoApprofondimentoParadossiTempoBloccato"] = i
    i += 1
    ...
    i += 1
    dictAvanzamentoStoria["dialogoImpoPostRisveglioVulcano"] = i
    i += 1
    ...
    i += 1
    dictAvanzamentoStoria["monologoVistoImpoNonOstili1"] = i
    i += 1
    dictAvanzamentoStoria["monologoVistoImpoNonOstili2"] = i
    i += 1
    ...
    i += 1
    dictAvanzamentoStoria["chiusoGliOcchiSulCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["avviatoCalcolatore"] = i
    dictAvanzamentoStoria["inizioUsoCalcolatore"] = i
    dictAvanzamentoStoria["lasciatoImpoNelLaboratorioDiNeil"] = i
    i += 1
    dictAvanzamentoStoria["apparizioneNelCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["monologoPostApparizioneNelCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["apparizioneStanzaNelCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["sentitoVoceCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["monologoPostApparizioneStanzaNelCalcolatore1"] = i
    i += 1
    dictAvanzamentoStoria["monologoPostApparizioneStanzaNelCalcolatore2"] = i
    i += 1
    dictAvanzamentoStoria["monologoPostApparizioneStanzaNelCalcolatore3"] = i
    i += 1
    dictAvanzamentoStoria["monologoVistoPortaLaboratorioAggiustata"] = i
    i += 1
    dictAvanzamentoStoria["monologoConfusoSuComeOltrepassareLaPortaDelLaboratorio"] = i
    i += 1
    dictAvanzamentoStoria["giratoPostIndecisoSuComeAttraversarePortaLaboratorio"] = i
    i += 1
    dictAvanzamentoStoria["monologoPostAttraversamentoPortachiusaLaboratorio1"] = i
    i += 1
    dictAvanzamentoStoria["monologoPostAttraversamentoPortachiusaLaboratorio2"] = i
    i += 1
    dictAvanzamentoStoria["monologoImpossibilitaRaggiungereInFrettaUfficioDiNeil"] = i
    i += 1
    dictAvanzamentoStoria["monologoPrimoComandoViaggioRapidoCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["monologoDuranteViaggioRapidoCalcolatore1UfficioNeil"] = i
    i += 1
    dictAvanzamentoStoria["viaggioRapidoCalcolatore1UfficioNeil"] = i
    i += 1
    dictAvanzamentoStoria["monologoPostViaggioRapidoCalcolatore1UfficioNeil"] = i
    i += 1
    dictAvanzamentoStoria["interagitoConTeNelCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["monologoPreAvvioSequenzaEventiCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["avviatoSequenzaDiEventiCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["monologoPostAvvioSequenzaDiEventiCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["monologo1RenéPostAvvioSequenzaDiEventiCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["monologo2RenéPostAvvioSequenzaDiEventiCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["RenéUscitoDallUfficioDiNeilPostAvvioSequenzaDiEventiCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["monologoPostUscitaDiRenéPostAvvioSequenzaDiEventiCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["inizioViaggioTemporaleIndietroDi10MinutiInInternoCastello20"] = i
    i += 1
    dictAvanzamentoStoria["tornatoIndietroNelTempoAPrimaCheNeilLasciasseIlSuoUfficio"] = i
    i += 1
    dictAvanzamentoStoria["dialogo1RenéNeilPostAvvioSequenzaNelCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["dialogo2RenéNeilPostAvvioSequenzaNelCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["NeilUscitoDaUfficioPostAvvioSequenzaNelCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["monologoStopTempoPreAscensoreDiNeilMentreSeiNelCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["monologoPostStopTempoPreAscensoreDiNeilMentreSeiNelCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["monologoRiavvioTempoPreAscensoreDiNeilMentreSeiNelCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["NeilUscitoDaInternoCastello2PostAvvioSequenzaNelCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["NeilUscitoDaInternoCastello7PostAvvioSequenzaNelCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["NeilUscitoDaInternoCastello8PostAvvioSequenzaNelCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["NeilUscitoDaTunnelSubaqueo1PostAvvioSequenzaNelCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["NeilUscitoDaTunnelSubaqueo2PostAvvioSequenzaNelCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["monologoArrivoLaboratorioDiNeilDelPassato1"] = i
    i += 1
    dictAvanzamentoStoria["monologoArrivoLaboratorioDiNeilDelPassato2"] = i
    i += 1
    dictAvanzamentoStoria["sdraiatoNeilSulLettoDelLaboratorio"] = i
    i += 1
    dictAvanzamentoStoria["chiusoOcchiNeilSulLettoDelLaboratorio"] = i
    i += 1
    dictAvanzamentoStoria["trasformatoLaboratorioDiNeil"] = i
    dictAvanzamentoStoria["NeilEntratoNellaCellaDelSuoLaboratorio"] = i
    i += 1
    dictAvanzamentoStoria["riavviatoSottofondoAmbientalePostTrasformazioneLaboratorio"] = i
    i += 1
    dictAvanzamentoStoria["monologo1PostTrasformazioneLaboratorio"] = i
    i += 1
    dictAvanzamentoStoria["dialogoCellaNeilPostTrasformazioneLaboratorio1"] = i
    i += 1
    dictAvanzamentoStoria["monologo2PostTrasformazioneLaboratorio"] = i
    i += 1
    dictAvanzamentoStoria["dialogoCellaNeilPostTrasformazioneLaboratorio2"] = i
    i += 1
    dictAvanzamentoStoria["monologoConCalcolatoreRaggiuntoMomentoPresente"] = i
    i += 1
    dictAvanzamentoStoria["sparitoNeilDallaCellaDelLaboratorio"] = i
    i += 1
    dictAvanzamentoStoria["monologo1PostScomparsaNeilDallaCella"] = i
    i += 1
    dictAvanzamentoStoria["monologo2PostScomparsaNeilDallaCella"] = i
    i += 1
    dictAvanzamentoStoria["tornatoIndietroNelTempo10SecInLaboratorio"] = i
    i += 1
    dictAvanzamentoStoria["monologoPostTornatoIndietroNelTempo10SecInLaboratorio"] = i
    i += 1
    dictAvanzamentoStoria["sparitoNeilDallaCellaDelLaboratorioSecondaVolta"] = i
    i += 1
    dictAvanzamentoStoria["monologo1PostSecondaSparizioneDiNeilDalLaboratorio"] = i
    i += 1
    dictAvanzamentoStoria["monologo2PostSecondaSparizioneDiNeilDalLaboratorio"] = i
    i += 1
    dictAvanzamentoStoria["arrivatoRenéNelTunnelSubacqueo1"] = i
    i += 1
    dictAvanzamentoStoria["arrivatoRenéNelTunnelSubacqueo2"] = i
    i += 1
    dictAvanzamentoStoria["arrivatoRenéNelLaboratorioDiNeil"] = i
    i += 1
    dictAvanzamentoStoria["monologo1RenéNelLaboratorioDiNeil"] = i
    i += 1
    dictAvanzamentoStoria["monologo2RenéNelLaboratorioDiNeil"] = i
    i += 1
    dictAvanzamentoStoria["monologo3RenéNelLaboratorioDiNeil"] = i
    i += 1
    dictAvanzamentoStoria["monologo4RenéNelLaboratorioDiNeil"] = i
    i += 1
    dictAvanzamentoStoria["sedutoSulCalcolatoreRenéNelLaboratorioDiNeil"] = i
    i += 1
    dictAvanzamentoStoria["monologoAttesaRenéSulCalcolatore1"] = i
    i += 1
    dictAvanzamentoStoria["monologoAttesaRenéSulCalcolatore2"] = i
    i += 1
    dictAvanzamentoStoria["passatoDieciMinAspettandoRenéSulCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["passatoUnOraAspettandoRenéSulCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["passatoDueOreAspettandoRenéSulCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["passatoCinqueOreAspettandoRenéSulCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["passatoUnGiornoAspettandoRenéSulCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["passatoTreGiorniAspettandoRenéSulCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["cambiatoStanzaPerAggiornareImgRenéSuCalcolatore"] = i
    dictAvanzamentoStoria["RenéOperatoComeTeENeilSulCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["passatoUnMeseAspettandoRenéSulCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["passatoCinqueMesiAspettandoRenéSulCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["passatoUnAnnoAspettandoRenéSulCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["passatoCinqueAnniAspettandoRenéSulCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["aggiornatoStanzaPerDistruzioneDelMondo1"] = i
    i += 1
    dictAvanzamentoStoria["passatoDieciAnniAspettandoRenéSulCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["monologo1NotatoTuttoDistruttoDopoDieciAnniDiAttesaPerRené"] = i
    i += 1
    dictAvanzamentoStoria["monologo2NotatoTuttoDistruttoDopoDieciAnniDiAttesaPerRené"] = i
    i += 1
    dictAvanzamentoStoria["tornatoIndietroDieciAnniAspettandoRenéSulCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["passatoUnAnno1AspettandoRenéSulCalcolatorePostVisioneDellaDistruzione"] = i
    i += 1
    dictAvanzamentoStoria["passatoUnAnno2AspettandoRenéSulCalcolatorePostVisioneDellaDistruzione"] = i
    i += 1
    dictAvanzamentoStoria["aggiornatoStanzaPerDistruzioneDelMondo2"] = i
    i += 1
    dictAvanzamentoStoria["monologoPerTornareIndietroDopoDistruzioneDelMondo2"] = i
    i += 1
    dictAvanzamentoStoria["tornatoIndietroSeiMesiAspettandoRenéSulCalcolatorePostVisioneDellaDistruzione"] = i
    i += 1
    dictAvanzamentoStoria["passatoUnMese1AspettandoRenéSulCalcolatorePostVisioneDellaDistruzione"] = i
    i += 1
    dictAvanzamentoStoria["passatoUnMese2AspettandoRenéSulCalcolatorePostVisioneDellaDistruzione"] = i
    i += 1
    dictAvanzamentoStoria["aggiornatoStanzaPerDistruzioneDelMondo3"] = i
    i += 1
    dictAvanzamentoStoria["tornatoIndietroQuindiciGiorniAspettandoRenéSulCalcolatorePostVisioneDellaDistruzione"] = i
    i += 1
    dictAvanzamentoStoria["monologoPerTornareIndietroDieciGiorniAspettandoRenéSulCalcolatorePostVisioneDellaDistruzione"] = i
    i += 1
    dictAvanzamentoStoria["tornatoIndietroDieciGiorniAspettandoRenéSulCalcolatorePostVisioneDellaDistruzione"] = i
    i += 1
    dictAvanzamentoStoria["monologoPerPassareUnGiornoAspettandoRenéSulCalcolatorePostVisioneDellaDistruzione"] = i
    i += 1
    dictAvanzamentoStoria["passatoUnGiornoAspettandoRenéSulCalcolatorePostVisioneDellaDistruzione"] = i
    i += 1
    dictAvanzamentoStoria["monologoNotatoRenéScomparsoDalCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["monologoPerTornareIndietroCinqueOreAspettandoRenéSulCalcolatorePostVisioneDellaDistruzione"] = i
    i += 1
    dictAvanzamentoStoria["tornatoIndietroCinqueOreAspettandoRenéSulCalcolatorePostVisioneDellaDistruzione"] = i
    i += 1
    dictAvanzamentoStoria["passatoDueOreAspettandoRenéSulCalcolatorePostVisioneDellaDistruzione"] = i
    i += 1
    dictAvanzamentoStoria["passatoUnOra1AspettandoRenéSulCalcolatorePostVisioneDellaDistruzione"] = i
    i += 1
    dictAvanzamentoStoria["passatoUnOra2AspettandoRenéSulCalcolatorePostVisioneDellaDistruzione"] = i
    i += 1
    dictAvanzamentoStoria["monologoPerPassareUnOra3AspettandoRenéSulCalcolatorePostVisioneDellaDistruzione"] = i
    i += 1
    dictAvanzamentoStoria["passatoUnOra3AspettandoRenéSulCalcolatorePostVisioneDellaDistruzione"] = i
    i += 1
    dictAvanzamentoStoria["monologoNotatoAssenzaRenéCalcolatore2"] = i
    i += 1
    dictAvanzamentoStoria["monologoPerTornareIndietroDieciMinutiAspettandoRenéSulCalcolatorePostVisioneDellaDistruzione"] = i
    i += 1
    dictAvanzamentoStoria["tornatoIndietroDieciMinutiAspettandoRenéSulCalcolatorePostVisioneDellaDistruzione"] = i
    i += 1
    dictAvanzamentoStoria["alzatoRenéDalCalcolatoreDopoSetteAnni"] = i
    i += 1
    dictAvanzamentoStoria["monologoVistoRenéOperatoDopoCheèScesoDalCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["uscitoRenéDaLaboratorioDiNeilPreFineDelMondo"] = i
    i += 1
    dictAvanzamentoStoria["uscitoRenéDaTunnelSubaqueo2PreFineDelMondo"] = i
    i += 1
    dictAvanzamentoStoria["uscitoRenéDaTunnelSubaqueo1PreFineDelMondo"] = i
    i += 1
    dictAvanzamentoStoria["apertoPortaInternoCastello8DaRenéPreFineDelMondo"] = i
    i += 1
    dictAvanzamentoStoria["uscitoRenéDaInternoCastello8PreFineDelMondo"] = i
    i += 1
    dictAvanzamentoStoria["uscitoRenéDaInternoCastello7PreFineDelMondo"] = i
    i += 1
    dictAvanzamentoStoria["uscitoRenéDaInternoCastello2PreFineDelMondo"] = i
    i += 1
    dictAvanzamentoStoria["uscitoRenéDaInternoCastello1PreFineDelMondo"] = i
    i += 1
    dictAvanzamentoStoria["uscitoRenéDaEsternoCastello5PreFineDelMondo"] = i
    i += 1
    dictAvanzamentoStoria["apertoCancelloCastelloDaRenéPreFineDelMondo"] = i
    i += 1
    dictAvanzamentoStoria["uscitoRenéDaEsternoCastello4PreFineDelMondo"] = i
    i += 1
    dictAvanzamentoStoria["uscitoRenéDaEsternoCastello2PreFineDelMondo"] = i
    i += 1
    dictAvanzamentoStoria["uscitoRenéDaEsternoCastello1PreFineDelMondo"] = i
    i += 1
    dictAvanzamentoStoria["uscitoRenéDaScorciatoiaLabirinto1PreFineDelMondo"] = i
    i += 1
    dictAvanzamentoStoria["uscitoRenéDaScorciatoiaLabirinto2PreFineDelMondo"] = i
    i += 1
    dictAvanzamentoStoria["apertoSbarreTunnelDiRodDaRenéPreFineDelMondo"] = i
    i += 1
    dictAvanzamentoStoria["uscitoRenéDaAvampostoDiRod2PreFineDelMondo"] = i
    i += 1
    dictAvanzamentoStoria["uscitoRenéDaTunnelDiRod3PreFineDelMondo"] = i
    i += 1
    dictAvanzamentoStoria["uscitoRenéDaTunnelDiRod2PreFineDelMondo"] = i
    i += 1
    dictAvanzamentoStoria["uscitoRenéDaTunnelDiRod1PreFineDelMondo"] = i
    i += 1
    dictAvanzamentoStoria["uscitoRodDalPalazzoPreLancioMissile"] = i
    i += 1
    dictAvanzamentoStoria["dialogoRenéRod1PreLancioMissile"] = i
    i += 1
    dictAvanzamentoStoria["dialogoRenéRod2PreLancioMissile"] = i
    i += 1
    dictAvanzamentoStoria["monologoRod1PreLancioMissile"] = i
    i += 1
    dictAvanzamentoStoria["dialogoRenéRod3PreLancioMissile"] = i
    i += 1
    dictAvanzamentoStoria["monologoRod2PreLancioMissile"] = i
    i += 1
    dictAvanzamentoStoria["avvioLancioMissileNucleare"] = i
    i += 1
    dictAvanzamentoStoria["missileNucleareScoppiato"] = i
    i += 1
    dictAvanzamentoStoria["conclusioneAnimazioneDistruzionePostScoppioMissile"] = i
    i += 1
    dictAvanzamentoStoria["monologoPostFineDelMondo1"] = i
    i += 1
    dictAvanzamentoStoria["monologoPostFineDelMondo2"] = i
    i += 1
    dictAvanzamentoStoria["andatoACasaPerVedereLoScoppioDelMissile"] = i
    i += 1
    dictAvanzamentoStoria["monologoPerTornareIndietroAPrimaDelloScoppioDelMissileACasa"] = i
    i += 1
    dictAvanzamentoStoria["tornatoIndietroAPrimaDelloScoppioDelMissileACasa"] = i
    i += 1
    dictAvanzamentoStoria["dialogoMadre1PreScoppioMissileSecondaVolta"] = i
    i += 1
    dictAvanzamentoStoria["dialogoMadre2PreScoppioMissileSecondaVolta"] = i
    i += 1
    dictAvanzamentoStoria["missileNucleareScoppiatoSecondaVolta"] = i
    i += 1
    dictAvanzamentoStoria["stoppatoTempoCalcolatorePreDistruzioneDiCasaTua"] = i
    i += 1
    dictAvanzamentoStoria["riapertoGliOcchiSulCalcolatorePostStopTempoACasaTua"] = i
    i += 1
    dictAvanzamentoStoria["toltoCascoCalcolatorePostScopertaFineDelMondo"] = i
    i += 1
    dictAvanzamentoStoria["scesoDalCalcolatorePostScopertaFineDelMondo"] = i
    i += 1
    dictAvanzamentoStoria["risalitoSulCalcolatorePostScopertaFineDelMondo"] = i
    i += 1
    dictAvanzamentoStoria["tornatoNelCalcolatoreACasaTua"] = i
    i += 1
    dictAvanzamentoStoria["monologoPerTornareIndietroNelTempoAllaSeraDellInizioDelGioco"] = i
    i += 1
    dictAvanzamentoStoria["tornatoIndietroNelTempoAllaSeraDellInizioDelGioco"] = i
    i += 1
    dictAvanzamentoStoria["riavviatoSequenzaEventiNellaSeraDellInizioDelGioco"] = i
    i += 1
    dictAvanzamentoStoria["HansUscitoDaCasa1NellaSeraDellInizioDelGioco"] = i
    i += 1
    dictAvanzamentoStoria["HansUscitoDaCasa2NellaSeraDellInizioDelGioco"] = i
    i += 1
    dictAvanzamentoStoria["HansUscitoDaCasa4NellaSeraDellInizioDelGioco"] = i
    i += 1
    dictAvanzamentoStoria["HansUscitoDaForestaCadetta1NellaSeraDellInizioDelGioco"] = i
    i += 1
    dictAvanzamentoStoria["HansUscitoDaForestaCadetta2NellaSeraDellInizioDelGioco"] = i
    i += 1
    dictAvanzamentoStoria["arrivataInForestaCadetta5Calcolatore"] = i
    i += 1
    dictAvanzamentoStoria["dialogoHansSamCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["comparsiCinghialiForestaCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["dialogoCinghialeCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["colpitoHansDalCinghialeCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["SamScappatoDaForesta5PostUccisioneHansCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["secondoCinghialeUscitoDaForesta5PostUccisioneHansCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["avvicinataAllaSiepeConHansEIlCinghialeCalcolatore"] = i
    dictAvanzamentoStoria["apparsaSaraInForesta5Calcolatore"] = i
    dictAvanzamentoStoria["arrivataSaraAllaSiepeConHansEIlCinghialeCalcolatore"] = i
    i += 1
    dictAvanzamentoStoria["SaraUscitaDaForestaCadetta5Calcolatore"] = i
    i += 1
    dictAvanzamentoStoria["tornatoIndietroPerUrloDiHans1Pt1"] = i
    i += 1
    dictAvanzamentoStoria["tornatoIndietroPerUrloDiHans1Pt2"] = i
    i += 1
    dictAvanzamentoStoria["tornatoIndietroPerUrloDiHans2Pt1"] = i
    i += 1
    dictAvanzamentoStoria["tornatoIndietroPerUrloDiHans2Pt2"] = i
    i += 1
    dictAvanzamentoStoria["tornatoIndietroPerUrloDiHans3"] = i
    i += 1
    ...
    i += 1
    dictAvanzamentoStoria["monologoPostPassatiMoltiAnniSulCalcolatore"] = i
    i += 1
