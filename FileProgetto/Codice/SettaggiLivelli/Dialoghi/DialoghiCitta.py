    ...
    if tipo == "PadreUfficialeServizio":
        ...
        if tipo == "Ragazzo1":
            ...
            if avanzamentoStoria < GlobalGameVar.dictAvanzamentoStoria["inizioViaggioVersoNeil"] and avanzamentoDialogo == 0:
                ...
                dialogo = []
                dialogo.append("personaggio")
                dialogo.append(u"No, non è richiesta. Ma più ne metti, più ne comprano.")
                partiDialogo.append(dialogo)
                dialogo = []
                dialogo.append("tu")
        ...
        if tipo == "GuardiaCitta":
            ...
            if x == GlobalHWVar.gpx * 16:
                ...
                if avanzamentoStoria < GlobalGameVar.dictAvanzamentoStoria["inizioViaggioVersoNeil"] and avanzamentoDialogo == 0:
                    ...
                    dialogo = []
                    dialogo.append("personaggio")
                    dialogo.append(u"Cosa!? Sono in servizio... sono di guardia all'uscita sud. Non disturbare i soldati se non necessiti d'aiuto.")
                    partiDialogo.append(dialogo)
                    dialogo = []
                    dialogo.append("tu")
                    ...
                    dialogo = []
                    dialogo.append("personaggio")
                    dialogo.append(u"Non disturbare i soldati se non necessiti d'aiuto.")
                    partiDialogo.append(dialogo)
                elif avanzamentoStoria < GlobalGameVar.dictAvanzamentoStoria["tempoBloccato"]:
                    oggettoDato = False
                    avanzaStoria = False
