...
def setDialogo(tipoId, x, y, avanzamentoStoria, stanzaDiAppartenenza, avanzamentoDialogo, monetePossedute):
    ...
    if tipo == "PadreUfficialeServizio":
        ...
        if avanzamentoStoria == GlobalGameVar.dictAvanzamentoStoria["entratoInCittà"]:
            ...
            dialogo = []
            dialogo.append("tu")
            dialogo.append(u"Sono... uhm... mi chiamo Sara e sto cercando mio fratello. Si chiama Hans e ha più o meno la mia età. Dovrebbe essere passato di qui non molto tempo fa...")
            partiDialogo.append(dialogo)
            dialogo = []
            dialogo.append("personaggio")
        ...
        if avanzamentoStoria == GlobalGameVar.dictAvanzamentoStoria["uscitoCasaDavid"]:
            ...
            dialogo = []
            dialogo.append("tu")
            dialogo.append(u"Cosa?! " + str(GlobalGameVar.monetePerEntrareNellaConfraternita) + u" monete?! Per rispondere a una domanda?!")
            partiDialogo.append(dialogo)
            dialogo = []
            dialogo.append("personaggio")
            ...
            dialogo = []
            dialogo.append("personaggio")
            dialogo.append(u"Mi dispiace, non posso rivelare informazioni a chi non è nella cofraternita... è una delle regole...")
            partiDialogo.append(dialogo)
            dialogo = []
            dialogo.append("tu")
            dialogo.append(u"Certo, sono sicura che tu non te lo sia appena inventato... " + str(GlobalGameVar.monetePerEntrareNellaConfraternita) + u" monete per avere l'opportunità di spendere altre monete per delle \"risorse\"... Non mi sento per niente truffata, anzi sembra proprio un'opportunità da prendere al volo.")
            partiDialogo.append(dialogo)
            dialogo = []
            dialogo.append("personaggio")
            ...
            if monetePossedute < GlobalGameVar.monetePerEntrareNellaConfraternita:
                ...
                dialogo = []
                dialogo.append("tu")
                dialogo.append(u"Tieni le " + str(GlobalGameVar.monetePerEntrareNellaConfraternita) + u" monete... uhm... non so ancora il tuo nome...")
                partiDialogo.append(dialogo)
                dialogo = []
                dialogo.append("personaggio")
        ...
        if tipo == "Ragazzo1":
            ...
            if avanzamentoStoria < GlobalGameVar.dictAvanzamentoStoria["cercatoHansInAlloggiProfughi"] and avanzamentoDialogo == 0:
                ...
                dialogo = []
                dialogo.append("personaggio")
                dialogo.append(u"Chiunque sia, se vive in quel posto, non merita di averti. Io posso portarti a vivere nelle migliori ville cittadine quando lo desideri.")
                partiDialogo.append(dialogo)
                dialogo = []
                dialogo.append("tu")
        ...
        if tipo == "GuardiaCitta":
            ...
            if x == GlobalHWVar.gpx * 16:
                ...
                if avanzamentoStoria < GlobalGameVar.dictAvanzamentoStoria["ricevutoImpo"] and avanzamentoDialogo == 0:
                    ...
                    dialogo = []
                    dialogo.append("personaggio")
                    dialogo.append(u"Ehmm... non ho la chiave...")
                    partiDialogo.append(dialogo)
                    dialogo = []
                    dialogo.append("tu")
