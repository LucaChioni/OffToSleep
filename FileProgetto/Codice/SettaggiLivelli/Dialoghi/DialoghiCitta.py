...
def setDialogo(tipoId, x, y, avanzamentoStoria, stanzaDiAppartenenza, avanzamentoDialogo, monetePossedute):
    ...
    if tipo == "PadreUfficialeServizio":
        ...
        if stanzaDiAppartenenza == GlobalGameVar.dictStanze["città1"]:
            if y == GlobalHWVar.gpy * 2:
                if avanzamentoStoria < GlobalGameVar.dictAvanzamentoStoria["inizioSecondoGiorno"]:
                    ...
                    dialogo = []
                    dialogo.append("personaggio")
                    dialogo.append(u"Vai con il generale, qua ci pensiamo noi.")
                    partiDialogo.append(dialogo)
                else:
                    oggettoDato = False
                    avanzaStoria = False
        ...
        if avanzamentoStoria == GlobalGameVar.dictAvanzamentoStoria["uscitoCasaDavid"]:
            ...
            dialogo = []
            dialogo.append("tu")
            dialogo.append(u"È dove batte il cuore, ho capito. Senti, volevo chiederti se... ma perché continui a guardarti intorno!?")
            partiDialogo.append(dialogo)
            dialogo = []
            dialogo.append("personaggio")
            ...
            dialogo = []
            dialogo.append("personaggio")
            dialogo.append(u"Cosa!? Nessuno in particolare, ho detto! Poi non posso fissare qualcuno se continuo a guardarmi attorno, no?")
            partiDialogo.append(dialogo)
            dialogo = []
            dialogo.append("tu")
            ...
            dialogo = []
            dialogo.append("personaggio")
            dialogo.append(u"... Non parlerò senza compenso. Sono 100 monete.")
            partiDialogo.append(dialogo)
            dialogo = []
            dialogo.append("tu")
            dialogo.append(u"100 monete!? Per rispondere a una domanda!?")
            partiDialogo.append(dialogo)
            dialogo = []
            dialogo.append("personaggio")
            ...
            dialogo = []
            dialogo.append("tu")
            dialogo.append(u"Certo, sono sicura che tu non te lo sia appena inventato... 100 monete per avere l'opportunità di pagare altre monete per delle \"risorse\"... Non mi sento per niente truffata, anzi sembra un'opportunità da prendere al volo.")
            partiDialogo.append(dialogo)
            dialogo = []
            dialogo.append("personaggio")
            ...
            partiDialogo.append(dialogo)
        elif avanzamentoStoria == GlobalGameVar.dictAvanzamentoStoria["richieste100MoneteDalMercante"]:
            if monetePossedute < 100:
                nome = "Sconosciuto"
                oggettoDato = False
                avanzaStoria = False
                menuMercante = False
                ...
                dialogo = []
                dialogo.append("tu")
                dialogo.append(u"Senti, mi potresti dire dove hai visto mio fratello come favore? Poi valuterei molto più seriamente di entrare nella confraternita. Anzi entrerei di sicuro.")
                partiDialogo.append(dialogo)
                dialogo = []
                dialogo.append("personaggio")
                dialogo.append(u"Certo, sono 100 monete.")
                partiDialogo.append(dialogo)
                dialogo = []
                dialogo.append("tu")
                dialogo.append(u"...")
                ...
                dialogo = []
                dialogo.append("tu")
                dialogo.append(u"Tieni le 100 monete... ehm... non so ancora il tuo nome...")
                partiDialogo.append(dialogo)
                dialogo = []
                dialogo.append("personaggio")
                ...
                dialogo = []
                dialogo.append("tu")
                dialogo.append(u"... Uff! Assurdo... Siamo arrivati durante la notte. Mio fratello è arrivato prima di me e gli è stato assegnato un alloggio che, a quanto pare, era l'ultimo rimasto. Perciò io sono stata ospite di David, il capitano della guardia notturna.")
                partiDialogo.append(dialogo)
                dialogo = []
                dialogo.append("personaggio")
        ...
        if tipoId == "Ragazzo1-6":
            if avanzamentoStoria == GlobalGameVar.dictAvanzamentoStoria["uscitoCasaDavidDopoSuicidio"]:
                ...
                dialogo = []
                dialogo.append("personaggio")
                dialogo.append(u"Vieni qui, puttana!")
                partiDialogo.append(dialogo)
    elif tipo == "Ragazzo2":
        partiDialogo = []
        nome = "Sconosciuto"
