    ...
    if tipoId == "OggettoQuadro-1":
        ...
        if tipoId == "Neil-0":
            ...
            if avanzamentoStoria == GlobalGameVar.dictAvanzamentoStoria["bussatoPortaStudioDiNeil"]:
                ...
                dialogo = []
                dialogo.append("personaggio")
                dialogo.append(u"<*>#italic#Mmh...<*> e cosa \"serve\" in particolare?")
                partiDialogo.append(dialogo)
                dialogo = []
                dialogo.append("tu")
                ...
                dialogo = []
                dialogo.append("tu")
                dialogo.append(u"Anche il mio Impo vale molto.")
                partiDialogo.append(dialogo)
                dialogo = []
                dialogo.append("personaggio")
                ...
                dialogo = []
                dialogo.append("tu")
                dialogo.append(u"Faccio anche parte della sua confraternita!")
                partiDialogo.append(dialogo)
                dialogo = []
                dialogo.append("personaggio")
