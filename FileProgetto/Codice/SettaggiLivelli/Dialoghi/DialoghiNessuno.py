...
def setDialogo(tipo, x, y, avanzamentoStoria, stanzaDiAppartenenza, avanzamentoDialogo):
    ...
    if avanzamentoStoria == GlobalGameVar.dictAvanzamentoStoria["inizio"]:
        ...
        partiDialogo.append(dialogo)
    elif avanzamentoStoria < GlobalGameVar.dictAvanzamentoStoria["secondoCambioPersonaggio"] and x == GlobalHWVar.gpx * 24 and y == GlobalHWVar.gpy * 3 and stanzaDiAppartenenza == GlobalGameVar.dictStanze["casaHansLucy1"]:
        oggettoDato = False
        avanzaStoria = False
        menuMercante = False
        scelta = False
        ...
        partiDialogo.append(dialogo)
    elif GlobalGameVar.dictAvanzamentoStoria["trovatoLegna1"] <= avanzamentoStoria < GlobalGameVar.dictAvanzamentoStoria["legnaDepositata"] and x == GlobalHWVar.gpx * 16 and y == GlobalHWVar.gpy * 1 and stanzaDiAppartenenza == GlobalGameVar.dictStanze["forestaCadetta5"]:
        oggettoDato = False
        avanzaStoria = False
        menuMercante = False
        scelta = False
        ...
        partiDialogo.append(dialogo)
    elif avanzamentoStoria == GlobalGameVar.dictAvanzamentoStoria["ultimaStanzaForesta"] and stanzaDiAppartenenza == GlobalGameVar.dictStanze["stradaPerCittà1"]:
        oggettoDato = False
        avanzaStoria = True
        menuMercante = False
        scelta = False
        ...
        dialogo.append("...")
        partiDialogo.append(dialogo)
    elif stanzaDiAppartenenza == GlobalGameVar.dictStanze["casaDavid1"] or stanzaDiAppartenenza == GlobalGameVar.dictStanze["casaDavid2"] or stanzaDiAppartenenza == GlobalGameVar.dictStanze["casaDavid3"]:
