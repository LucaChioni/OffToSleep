        ...
        if tipo == "ServoLancia":
            ...
            if tipoId == "ServoLancia-0":
                ...
                if avanzamentoDialogo == 0:
                    ...
                    dialogo = []
                    dialogo.append("personaggio")
                    dialogo.append(u"... Non aspetta ospiti, sarà sicuramente impegnato. L'entrata è da quella parte ma senza un invito non ti faranno entrare.")
                    partiDialogo.append(dialogo)
                    dialogo = []
                    dialogo.append("tu")
            ...
            if tipoId == "ServoLancia-2":
                if avanzamentoStoria < GlobalGameVar.dictAvanzamentoStoria["apertoCancelloPrincipaleCastello"]:
                    if avanzamentoDialogo == 0:
                        ...
                        dialogo = []
                        dialogo.append("personaggio")
                        dialogo.append(u"<*>#italic#Hahaha...<*> I giovani d'oggi! Avete proprio la faccia come il culo! Levati di torno.")
                        partiDialogo.append(dialogo)
                        dialogo = []
                        dialogo.append("tu")
