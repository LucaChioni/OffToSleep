    ...
    if GlobalGameVar.dictStanze["sognoSara1"] <= stanzaDiAppartenenza <= GlobalGameVar.dictStanze["sognoSara4"]:
        ...
        if stanzaDiAppartenenza == GlobalGameVar.dictStanze["caverna18"]:
            if avanzamentoStoria == GlobalGameVar.dictAvanzamentoStoria["monologoVistoImpoNonOstili2"]:
                ...
                dialogo = []
                dialogo.append("tu")
                dialogo.append(u"Ma che...?! Da qui ci siamo venuti...")
                partiDialogo.append(dialogo)
                dialogo = []
                dialogo.append("tu")
                dialogo.append(u"...")
                ...
                dialogo = []
                dialogo.append("tu")
                dialogo.append(u"... <*>#italic#Uff...<*> Perché non capisco NIENTE?!")
                partiDialogo.append(dialogo)
        ...
        if stanzaDiAppartenenza == GlobalGameVar.dictStanze["laboratorioSegretoNeil1"]:
            if avanzamentoStoria == GlobalGameVar.dictAvanzamentoStoria["monologoArrivoTunnelSubacqueo"]:
                ...
                dialogo = []
                dialogo.append("tu")
                dialogo.append(u"(... E \"posiziono il casco\"...)")
                partiDialogo.append(dialogo)
                ...
                dialogo = []
                dialogo.append("tu")
                dialogo.append(u"(... Ok, quella linea immagino sia l'\"orizzonte\"...)")
                partiDialogo.append(dialogo)
                dialogo = []
                dialogo.append("tu")
                dialogo.append(u"(... \"Occhi paralleli\" e... chiusi...)")
                partiDialogo.append(dialogo)
                ...
                dialogo = []
                dialogo.append("tu")
                dialogo.append(u"... Perché non sono seduta lì?")
                partiDialogo.append(dialogo)
                dialogo = []
                dialogo.append("tu")
                dialogo.append(u"... Ha detto \"Momento serie di eventi: attuale\"...")
                partiDialogo.append(dialogo)
                dialogo = []
                dialogo.append("tu")
                ...
                dialogo = []
                dialogo.append("tu")
                dialogo.append(u"... Forse sono ancora nell'ufficio di Neil allora...")
                partiDialogo.append(dialogo)
                ...
                dialogo = []
                dialogo.append("tu")
                dialogo.append(u"... E non faccio più nessun rumore...")
                partiDialogo.append(dialogo)
            elif x == GlobalHWVar.gpx * 1:
                oggettoDato = False
                avanzaStoria = False
