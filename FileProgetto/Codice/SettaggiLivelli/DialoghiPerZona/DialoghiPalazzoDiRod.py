        ...
        if tipo == "Mercante":
            ...
            if avanzamentoStoria == GlobalGameVar.dictAvanzamentoStoria["entratoInPalazzoDiRod"]:
                ...
                if monetePossedute < GlobalGameVar.monetePerGliStumentiPerNeil:
                    ...
                    dialogo = []
                    dialogo.append("tu")
                    dialogo.append(u"<*>#italic#Ufff...<*> che stupida, scusa...")
                    partiDialogo.append(dialogo)
                    dialogo = []
                    dialogo.append("personaggio")
                ...
                dialogo = []
                dialogo.append("tu")
                dialogo.append(u"Oh... e come...? Cioè, so che i pappagalli ripetono le cose che sentono, ma come... cioè...")
                partiDialogo.append(dialogo)
                dialogo = []
                dialogo.append("personaggio")
